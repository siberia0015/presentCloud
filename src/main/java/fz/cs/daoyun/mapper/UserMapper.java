...
//    })
    @Insert("insert into t_user(name, password, salt, phone) values(#{name,jdbcType=VARCHAR}, " +
...
//    @Select({
//            "select",
//            "user_id, nickname, name, sex, email, phone, school, classes, school_number, CreationDate, ",
//            "Creator, Modifier, ModificationDate",
//            "from t_user"
//    })
//    @Results({
